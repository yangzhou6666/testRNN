...
def main():
    ...
    if modelName == 'sentiment': 
        if mode == 'train': 
            ...
            sentimentGenerateTestSuite(r,threshold_CC,threshold_MC,symbols_SQ,TestCaseNum,minimalTest,TargMetri,CoverageStop)

    elif modelName == 'mnist':
        if mode == 'train':
            mnist_lstm_train()
        else:
            mnist_lstm_test(r,threshold_CC,threshold_MC,symbols_SQ,TestCaseNum,minimalTest,TargMetri,CoverageStop)

    elif modelName == 'lipo':
        if mode == 'train':
            lipo_lstm_train()
        else:
            lipo_lstm_test(r,threshold_CC,threshold_MC,symbols_SQ,TestCaseNum,minimalTest,TargMetri,CoverageStop)
